...
class definition_expr:public ast_tree_node
{
	public:
		definition_expr():ast_tree_node()
		{
			;
		}
};
class assignment_expr:public ast_tree_node
{
	public:
		assignment_expr():ast_tree_node()
		{
			;
		}
};
class ifelse_expr:public ast_tree_node
{
	public:
		ifelse_expr():ast_tree_node()
		{
			;
		}
};
class loop_expr:public ast_tree_node
{
	public:
		loop_expr():ast_tree_node()
		{
			;
		}
};
class function_expr:public ast_tree_node
{
	public:
		function_expr():ast_tree_node()
		{
			;
		}
};
